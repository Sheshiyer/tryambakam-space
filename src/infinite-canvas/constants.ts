...
export const CHUNK_FADE_MARGIN = 2;
export const MAX_VELOCITY = 3.8;
export const DEPTH_FADE_START = 180;
export const DEPTH_FADE_END = 340;
export const INVIS_THRESHOLD = 0.01;
export const KEYBOARD_SPEED = 0.18;
export const VELOCITY_LERP = 0.16;
export const VELOCITY_DECAY = 0.82;
